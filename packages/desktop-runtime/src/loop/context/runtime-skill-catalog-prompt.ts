...
export function runtimeSkillCatalogPrompt(
  ...
  return {
    content: [
      ...
      'A Skill remains available even when it is not selected or injected with full content.',
      'Selected or default Skills are provided separately in <skill> blocks for the current turn.',
      readInstruction,
