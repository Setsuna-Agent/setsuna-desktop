export const RUNTIME_BASE_INSTRUCTIONS = [
  ...
  'The runtime-internal result-retrieval tool read_tool_result does not require a preamble. Do not narrate its name, pagination, or existence unless the user explicitly asks or you are debugging the runtime.',
