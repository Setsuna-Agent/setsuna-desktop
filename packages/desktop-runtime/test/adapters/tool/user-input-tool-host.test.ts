...
import { REQUEST_USER_INPUT_TOOL_NAME, UserInputToolHost } from '../../../src/adapters/tool/user-input-tool-host.js';
import type { RuntimeEventWriter } from '../../../src/loop/lifecycle/runtime-event-writer.js';
