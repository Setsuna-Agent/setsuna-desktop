import type { RuntimeThread, RuntimeToolRun } from '@setsuna-desktop/contracts';
...
function fixture(runs: RuntimeToolRun[]) {
  ...
  return {
    ...
    workspaceProjects: { applyFileChanges: vi.fn(async () => undefined), ensureTemporaryWorkspace: vi.fn() },
  };
}
