...
import { shellPolicyDecision } from '../../src/adapters/tool/pc-local/pc-local-tool-shell-policy.js';
import {
  analyzeShellCommandStructure,
  parseReusableShellCommand,
  reusableShellCommandWords,
} from '../../src/security/shell-command-analysis.js';
