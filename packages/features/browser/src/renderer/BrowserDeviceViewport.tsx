...
const browserDeviceResizeHandles = [
  { handle: 'left', labelKey: 'feature.browser.resize.left' },
  { handle: 'right', labelKey: 'feature.browser.resize.right' },
  { handle: 'bottom', labelKey: 'feature.browser.resize.bottom' },
  { handle: 'bottom-left', labelKey: 'feature.browser.resize.bottomLeft' },
  { handle: 'bottom-right', labelKey: 'feature.browser.resize.bottomRight' },
] as const satisfies ReadonlyArray<{ handle: BrowserDeviceResizeHandle; labelKey: BrowserMessageKey }>;
