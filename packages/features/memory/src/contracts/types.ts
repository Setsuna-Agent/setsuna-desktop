...
export type RuntimeMemoryStage1OutputList = { outputs: RuntimeMemoryStage1Output[] };
export type RuntimeMemoryList = { memories: RuntimeMemoryRecord[] };
export type RuntimeMemoryUsageUpdate = { updated: number; rolloutIds: string[] };
...
export type RuntimeMemoryFileEntry = { path: string; entryType: 'file' | 'directory' };
...
export type RuntimeMemoryFileReadInput = { path: string; lineOffset?: number; maxLines?: number };
