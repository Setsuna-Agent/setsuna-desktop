...
export function brandIconFileError(
  file: BrandIconFileMetadata,
  copy: BrandIconUploadCopy = defaultUploadCopy,
): string | null {
...
export function readBrandIconFile(
  file: File,
  copy: BrandIconUploadCopy = defaultUploadCopy,
): Promise<CustomBrandIcon> {
