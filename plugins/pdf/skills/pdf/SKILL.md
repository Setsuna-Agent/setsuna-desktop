...
1. Prefer visual review: render PDF pages to PNGs and inspect them.
   - Use `pdftoppm` from the current workspace or system Poppler when available.
...
- Write final artifacts under `output/pdf/` when working in a repository.
- Keep filenames stable and descriptive.

## Dependencies

Prefer dependencies already available in the current workspace or runtime:
