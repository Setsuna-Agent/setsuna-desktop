...
```text
apps/desktop/renderer/ — 0 direct / 459 total files
├── src/ — 2 direct / 337 total files
...
└── test/ — 122 files
    └── unit/ — 122 files
        ...
        │   │   ├── composer/ — 13 direct / 13 total files
...
├── designs/ — 2 direct / 2 total files
