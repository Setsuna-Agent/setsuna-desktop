...
├── src/ — 2 direct / 468 total files
│   ├── app/ — 2 direct / 38 total files
...
│   ├── composition/ — 14 direct / 14 total files
│   ├── features/ — 325 files
...
│   │   ├── settings/ — 10 direct / 62 total files
...
└── test/ — 178 files
    └── unit/ — 178 files
        ...
        │   ├── settings/ — 12 direct / 20 total files
...
```text
packages/features/ — 0 direct / 377 total files
