...
```text
apps/desktop/main/ — 0 direct / 121 total files
├── src/ — 2 direct / 76 total files
...
│   ├── webdav-sync/ — 17 direct / 17 total files
...
```text
apps/desktop/renderer/ — 0 direct / 679 total files
├── src/ — 2 direct / 499 total files
...
│   │   ├── settings/ — 11 direct / 72 total files
...
└── test/ — 180 files
    └── unit/ — 180 files
        ...
        │   ├── settings/ — 14 direct / 22 total files
...
```text
packages/features/ — 0 direct / 182 total files
├── browser/ — 2 direct / 64 total files
│   ├── src/ — 46 files
...
```text
packages/desktop-runtime/ — 4 direct / 570 total files
├── src/ — 2 direct / 334 total files
│   ├── adapters/ — 139 files
...
│   │   ├── store/ — 31 direct / 31 total files
...
│   ├── server/ — 25 direct / 47 total files
...
└── test/ — 232 files
    ...
    │   ├── lifecycle/ — 7 direct / 7 total files
    ...
    ├── support/ — 3 direct / 41 total files
    │   ├── agent-loop/ — 21 direct / 21 total files
