...
```text
apps/desktop/main/ — 0 direct / 102 total files
...
```text
apps/desktop/renderer/ — 0 direct / 570 total files
├── src/ — 2 direct / 415 total files
