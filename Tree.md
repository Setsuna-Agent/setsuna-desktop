...
```text
apps/desktop/renderer/ — 0 direct / 501 total files
├── src/ — 2 direct / 366 total files
...
```text
packages/desktop-runtime/ — 4 direct / 450 total files
├── src/ — 2 direct / 263 total files
│   ├── adapters/ — 112 files
