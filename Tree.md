...
```text
apps/desktop/main/ — 0 direct / 106 total files
├── src/ — 2 direct / 66 total files
...
```text
apps/desktop/renderer/ — 0 direct / 584 total files
...
│   │   ├── chat/ — 5 direct / 124 total files
│   │   │   ├── artifacts/ — 6 direct / 6 total files
│   │   │   ├── composer/ — 28 direct / 28 total files
...
│   │   ├── settings/ — 10 direct / 57 total files
...
└── test/ — 154 files
    └── unit/ — 154 files
        ...
        │   │   ├── composer/ — 18 direct / 18 total files
...
```text
packages/desktop-runtime/ — 4 direct / 518 total files
...
└── test/ — 214 files
    ...
    ├── loop/ — 28 files
    │   ├── context/ — 11 direct / 11 total files
