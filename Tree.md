...
```text
apps/desktop/renderer/ — 0 direct / 638 total files
├── src/ — 2 direct / 469 total files
...
│   │   │   └── tool-runs/ — 17 direct / 17 total files
...
│   ├── hooks/ — 3 direct / 3 total files
│   ├── loop/ — 66 files
│   │   ├── approval-review/ — 6 direct / 6 total files
...
└── test/ — 226 files
    ...
    ├── loop/ — 34 files
    │   ├── approval-review/ — 2 direct / 2 total files
