...
```text
apps/desktop/renderer/ — 0 direct / 639 total files
...
```text
packages/desktop-runtime/ — 4 direct / 575 total files
├── src/ — 2 direct / 333 total files
│   ├── adapters/ — 138 files
