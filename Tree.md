...
```text
apps/desktop/renderer/ — 0 direct / 492 total files
├── src/ — 2 direct / 360 total files
...
└── test/ — 182 files
    ...
    │   ├── store/ — 12 direct / 12 total files
