...
```text
apps/desktop/renderer/ — 0 direct / 609 total files
├── src/ — 2 direct / 430 total files
...
│   │   │   └── tool-runs/ — 21 direct / 21 total files
...
└── test/ — 179 files
    ...
    └── unit/ — 177 files
        ...
        │   └── renderer-plugins/ — 1 direct / 1 total files
        ├── features/ — 107 files
        │   ├── chat/ — 4 direct / 84 total files
        │   │   ├── composer/ — 22 direct / 22 total files
        │   │   ├── conversation/ — 29 direct / 30 total files
        ...
        │   │   └── tool-runs/ — 9 direct / 9 total files
        │   ├── settings/ — 6 direct / 8 total files
        │   │   └── data-root/ — 2 direct / 2 total files
        │   └── workspace/ — 4 direct / 15 total files
        │       ├── editor/ — 1 direct / 1 total files
...
```text
packages/contracts/ — 4 direct / 81 total files
├── src/ — 33 direct / 51 total files
...
```text
packages/renderer-ui/ — 3 direct / 33 total files
├── src/ — 22 direct / 28 total files
│   └── styles/ — 6 direct / 6 total files
└── test/ — 2 direct / 2 total files
```
...
│       ├── renderer/ — 2 direct / 2 total files
│       └── support/ — 1 direct / 1 total files
├── plugin-management/ — 2 direct / 33 total files
│   ├── src/ — 26 files
│   │   ├── contracts/ — 6 direct / 6 total files
...
│       ├── renderer/ — 1 direct / 1 total files
│       └── runtime/ — 1 direct / 1 total files
├── skills/ — 4 direct / 21 total files
│   ├── src/ — 13 files
│   │   ├── contracts/ — 4 direct / 4 total files
│   │   ├── renderer/ — 6 direct / 6 total files
│   │   └── runtime/ — 3 direct / 3 total files
...
```text
packages/desktop-runtime/ — 4 direct / 545 total files
...
└── test/ — 226 files
    ...
    ├── hooks/ — 1 direct / 1 total files
    ├── integration/ — 57 files
    │   ├── adapters/ — 10 files
    │   │   ├── skill/ — 1 direct / 1 total files
    │   │   ├── store/ — 1 direct / 1 total files
    │   │   └── tool/ — 8 direct / 8 total files
    │   ├── agent-loop/ — 28 direct / 28 total files
