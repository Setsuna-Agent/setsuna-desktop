...
```text
apps/desktop/renderer/ — 0 direct / 443 total files
...
│   │   ├── settings/ — 9 direct / 43 total files
...
```text
packages/desktop-runtime/ — 5 direct / 389 total files
├── src/ — 2 direct / 214 total files
│   ├── adapters/ — 91 files
