...
随后迁移 Vision Recognition、Terminal、Review、Browser、Collaboration、Memory 和 WebDAV Sync，用来确认同一所有权模型能覆盖设置、原生资源、工具和复杂恢复链路。
...
- Terminal、Review、Browser 和 WebDAV Sync 的 native/bridge 资源由 Feature owner 管理，宿主只注入窗口、路径、凭据、网络或 runtime 等窄能力。
