...
- [Renderer Plugin Runtime](current/renderer-plugin-runtime.md)：已实施；记录静态 Renderer Plugin、层级 Slot Tree、布局偏好、Inspector、第三方 host tree/sandbox UI、安全边界与 React client bundle 延期门槛。
